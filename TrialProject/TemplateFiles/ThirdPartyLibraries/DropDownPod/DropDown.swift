...
open class DropDown : UITextField{
    ...
    @IBInspectable public var borderColor_: UIColor =  UIColor.lightGray {
        didSet {
    ...
    @IBInspectable public var borderWidth_: CGFloat = 0.0 {
        didSet {
            layer.borderWidth = borderWidth_
        }
    }

    @IBInspectable public var cornerRadius_: CGFloat = 5.0 {
        didSet {
